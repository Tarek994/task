  ...
  return (
    <div className="main-cards ">
      <div className="first ">
          ...
          <div className="first-side ">
            <div className="card-content ">
              <div className="top-content ">
                <h2>Base</h2>
                <h1>
                  $89.00 <span className="year">/year</span>
                </h1>
              </div>
            </div>
        ...
        <button className="see-more-btn  " onClick={() => handleShowMore(id)}>
        ...
        <div className={`main-body ${showMore[id] ? "show" : "hide"}`}>
          ...
          <div className="content-body col-12">
            ...
            <p>
              <span style={{ fontSize: 20, minWidth: "30%", opacity: 0.3 }}>
                <GrGroup />
              </span>
              <span
                style={{
          ...
          <div className="seconde-content-body">
            ...
            <div className="content-body">
              ...
              <p style={{ fontSize: 14, paddingLeft: 30, paddingTop: 1 }}>
                Contact usually in 48 hours.{" "}
              </p>
              <p style={{ paddingLeft: 30, fontSize: 10 }}>
                Note: The tenancy law advice from the partner lawyer can be used
          ...
          <div className="first-side ">
            <div className="card-content ">
              <div className="top-content ">
                <h2>Per</h2>
                <h1>
                  $109.00 <span className="year">/year</span>
                </h1>
              </div>
            </div>
          ...
          <div className="first-side ">
            <div className="card-content ">
              <div className="top-content ">
                <h2>Premium</h2>
                <h1>
                  $149.00 <span className="year">/year</span>
                </h1>
              </div>
            </div>
